...
#define PRINT_DEBUG5(m,a,b,c,d,e)
  ...
  */
  ...
  public:
    ...
    /** Add a block to this model in. points are the vertexes of the polygon
     *  expressed in the model the local frame */
    void AddBlockPolygon(const std::vector<point_t>& points,
                              meters_t dz );
  ...
  public:
    ...
    float actuation_noise_parameters[6];
    ...
    Velocity velocity_odom_measurement;
